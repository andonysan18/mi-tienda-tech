            ...
            {filteredProducts.map((product) => (
              <div key={product.id} className="group relative flex flex-col gap-4">
                ...
                <div className="relative aspect-square rounded-3xl overflow-hidden bg-zinc-900 border border-white/5 group-hover:border-indigo-500/30 transition-all duration-500">
                    ...
                    {/* --- AQUÍ ESTÁ EL CAMBIO --- */}
                    {/* Botón añadido: Visible en móvil (opacity-100), Oculto en PC hasta Hover (lg:opacity-0) */}
                    <div className="absolute bottom-4 left-0 right-0 px-4 transition-all duration-300 z-30
