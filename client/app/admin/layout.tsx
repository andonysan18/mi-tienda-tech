...
export default function AdminLayout({
  ...
  return (
    <div className="flex min-h-screen bg-black text-zinc-200 font-sans selection:bg-indigo-500/30">
      ...
      {/* --- BACKGROUND GRID (Para consistencia con la tienda) --- */}
      ...
      <button 
        ...
        className="md:hidden fixed bottom-6 right-6 z-50 bg-indigo-600 p-4 rounded-full shadow-lg shadow-indigo-900/50 text-white hover:bg-indigo-500 transition-all active:scale-95"
      >
      ...
      {/* --- SIDEBAR --- */}
      <aside className={`
        fixed inset-y-0 left-0 z-40 w-72 bg-black/95 backdrop-blur-xl border-r border-white/10 
      ...
      `}>
        ...
        {/* PARTE INFERIOR (Usuario y Salida) */}
        <div className="p-4 border-t border-white/5 bg-zinc-900/30">
           ...
           <Link 
              href="/" 
              className="flex items-center justify-center gap-2 w-full px-4 py-2 rounded-lg text-zinc-400 text-xs font-bold hover:text-white hover:bg-white/5 transition-colors mb-1"
           >
      ...
      <main className="flex-1 overflow-y-auto h-screen relative z-10">
        ...
        {/* Header decorativo dentro del contenido */}
